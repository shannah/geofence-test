 ...
 * @author Shai Almog
 */
public class GeofenceTestStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "GeofenceTest";
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new GeofenceTestStub());
    }
